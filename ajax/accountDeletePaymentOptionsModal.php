<?php
    /**
    * This page serves as the call from the payment options delete modal on the accounts page
    */
    ...
    if(!empty($_POST)){ //Check that we are in a postback
        ...
        $sql =  "UPDATE `paymentmethods` SET `status` = 'DELETED' WHERE `payId` = ".trim($_POST['paymentId']);
