<?php
    ...
    function buildHeader(){
        ...
        */
        ...
        $returnString = $returnString .  "                        <a href=\"checkout.php\">";
        ...
        //Do a check here with the session variable 
        //If we have the session variable and it is greater than 0 show the account link
        //Instead of account use the users name they can click on like amazon
        //$returnString = $returnString .  "                            <li><a href=\"account.php\">Sign In</a></li>";
        
        //Else show the sign in link
        $returnString = $returnString .  "                            <li><a href=\"signin.php\">Sign In</a></li>";
        $returnString = $returnString .  "                            <li class=\"last\"><a href=\"contact.php\">Contact</a></li>";
        $returnString = $returnString .  "                        </ul>";
